...
% ---
\titulo{Apostila de Netbeans para Novatos}
\autor{Paulino Ng}
\local{Brasil}
\data{2019, v-0.5.0}
%\orientador{}
...
\hypersetup{
		...
		pdfkeywords={Netbeans}{programação}{Java}{C}{C++}, 
...
\begin{fichacatalografica}
	...
	\fbox{\begin{minipage}[c][6cm]{15.5cm}		% Largura
	\small
	\imprimirautor
...
%   This booklet is a very small tutorial on using Oracle's Netbeans, the IDE (integrated development environment) for Java programming. It presents also how to use Netbeans as a IDE to program C/C++.
%
%   \vspace{\onelineskip}
% 
%   \noindent 
%   \textbf{Keywords}: Netbeans. Java. Programming. IDE. C/C++.
% \end{otherlanguage*}
%\end{resumo}
...
%    Cette brochure résume le tutorial d’Oracle sur l’utilisation de netbeans, l’environnement de développement intégré (IDE) pour la programmation Java. On presente aussi l'utilisation pour la programmation C/C++.
% 
%   \textbf{Mots-clés}: Netbeans. Java. Programação. IDE. C/C++.
% \end{otherlanguage*}
%\end{resumo}
% ---
...
\legend{Fonte: https://netbeans.org/downloads/8.2/}
